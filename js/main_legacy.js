...
const fetch_url = `https://sheets.googleapis.com/v4/spreadsheets/1R1hyDMdNR6c7i3fUFTvyM894_FrCNwAakPXWM1DgtVI/values/Blad1!C108:G1000?key=${token}`;
    ...
    await Promise.all(getThumbnails(IDs)).then(thumbnails => {
        data.values.forEach((listItem, index) => {
            middle[0].insertAdjacentHTML("beforeend",`
                <div class="list-item">
                    <div class="list-number">#${index + 51}</div>
                    <div class="list-thumbnail">
